...
if($_SESSION["dominosdriver"]) {
	...
	echo 'Paycheck for pay period starting '.$payweek.'<br><br>';
	//set initial dates
	...
	$current = 'no';
	$totalhours = '0';
	$results1 = "SELECT id, clockin, clockout, current FROM dominostimeclock WHERE clockin >= ? AND clockin < ? AND driverid = ? AND current = ? ORDER BY clockin ASC";
	...
	echo '<table border="1"><tr><td style="background-color: white; color: black;">Total Hours</td><td style="color: white;">'.$totalhours.'</td></tr>';
	echo '<tr><td style="background-color: white; color: black;">Pay before taxes</td><td style="color: white;">$'.$paybeforetaxes.'</td></tr>';
	...
	echo '<tr><td style="background-color: white; color: black;">Total Tips</td><td style="color: white;">$'.$amountmade.'</td></tr>';
	$weeklytph = $amountmade / $totalhours;
	$weeklytph = round($weeklytph, 2);
	echo '<tr><td style="background-color: white; color: black;">Weekly average tips/hr</td><td style="color: white;">$'.$weeklytph.'</td></tr>';
	echo '</table><br>';
